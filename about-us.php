...
<?php 
include('includes/headerInner3.php');?>
    ...
    <div class="page-contain about-us">
        ...
        <div id="main-content" class="main-content">
            ...
            <div class="welcome-us-block">
                <div class="container">
                    <h4 class="title">Welcome to Greener Plants Store!</h4>
                   
                    <div class="text-wraper">
                        <p class="text-info">Greener is an online shop for the plant-curious operating in Jordan. We offer a selection of plants, planters, tools, and accessories. We deliver plants to your doorstep, and every plant from Greener comes with care information and the support of our of knowledgable plant team.
We believe plants make us happier, healthier, and boost creativity. They even clean the air we breathe! Our mission is to bridge the gap between plants and people, offering products and services that fit your personal style, lifestyle, and your budget.</p>
                        <p class="qt-text">“Green is the prime color of the world, and that from which its loveliness arises ...”</p>
                    </div> 
                </div>
            </div>
